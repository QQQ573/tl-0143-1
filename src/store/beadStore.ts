...
export const COLOR_PALETTE: Record<string, { hex: string; weight: number; name: string }> = {
  H01: { hex: '#FFFFFF', weight: 1.0, name: '乳白' },
  H02: { hex: '#000000', weight: 1.3, name: '纯黑' },
  H03: { hex: '#FF1744', weight: 1.2, name: '大红' },
  H04: { hex: '#FF9100', weight: 1.15, name: '橙' },
  H05: { hex: '#FFEA00', weight: 1.1, name: '明黄' },
  H06: { hex: '#00E676', weight: 1.1, name: '草绿' },
  H07: { hex: '#00B0FF', weight: 1.1, name: '天蓝' },
  H08: { hex: '#3D5AFE', weight: 1.2, name: '藏青' },
  H09: { hex: '#D500F9', weight: 1.15, name: '紫' },
  H10: { hex: '#FF80AB', weight: 1.1, name: '粉' },
  H11: { hex: '#A1887F', weight: 1.4, name: '深棕' },
